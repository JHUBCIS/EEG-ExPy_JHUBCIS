...
#> netsh advfirewall firewall add rule name="Open UDP Port 800" dir=in action=allow protocol=UDP localport=1000

# Create a new UDP client
$udpClient = New-Object System.Net.Sockets.UdpClient(800)
$endpoint = New-Object System.Net.IPEndPoint([System.Net.IPAddress]::Any, 0)

Write-Host "Listening for UDP packets..."
