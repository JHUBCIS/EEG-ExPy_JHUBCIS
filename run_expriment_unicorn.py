...
experiment = VisualSSVEP_select_unicorn(duration=record_duration, freq1=7, freq2=23, IP="127.0.0.1", Port=800) #note that most laptops only support up to 60 Hz. don't go above that
